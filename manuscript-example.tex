...
\title{Example Manuscript for AIAA Technical Conferences, using a Model-Based Approach}


\author{First A. Author and Second B. Author Jr.\footnote{Insert Job Title, Department Name, Address/Mail Stop, and AIAA Member Grade (if any) for first author.} and Second B. Author Jr.\footnote{Insert Job Title, Department Name, Address/Mail Stop, and AIAA Member Grade (if any) for second author.} }
\affil{Business or Academic Affiliation 1, City, State, Zip Code}

\author{Third C. Author\footnote{Insert Job Title, Department Name, Address/Mail Stop, and AIAA Member Grade (if any) for third author.} and Third C. Author\footnote{Insert Job Title, Department Name, Address/Mail Stop, and AIAA Member Grade (if any) for third author.} }
\affil{Business or Academic Affiliation 2, City, Province, Zip Code, Country}

\author{Fourth D. Author\footnote{Insert Job Title, Department Name, Address/Mail Stop, and AIAA Member Grade (if any) for fourth author.} }
\affil{}
...
\begin{abstract}
This manuscript gives you guidelines for preparing papers for AIAA Technical Conferences, generated using a model-based approach - i.e., a manuscript for generating manuscripts. Content and schemas are authored in YAML, while templates used for rendering/formatting are authored in the Jinja2 template language and \LaTeX{}/BibTeX typesetters/formatters. Define all symbols used in the abstract. Do not cite references in the abstract. The footnote on the first page should list the Job Title and AIAA Member Grade for each author, if known Authors do not have to be AIAA members.
...
\lettrine{T}{his} document contains content for preparing papers for AIAA Technical Conferences, generated using a model-based approach. As to provide as much separation of concerns between content and formatting, content and schemas (used for validating content) are defined in LinkML (a YAML-based modeling language for linked data models), while templates used for rendering/formatting are defined in the Jinja2 template language and \LaTeX{}/BibTeX typesetters/formatters. If you are reading a hard-copy or .pdf version of this document, you can clone the source code for this manuscript from https://github.com/ODU-CGA-CubeSat/manuscript-example and use it to prepare your manuscript.
